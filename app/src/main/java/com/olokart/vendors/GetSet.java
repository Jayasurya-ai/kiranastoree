...
class GetSet {
    ...
    String product_name, product_quant, bagprice, product_image, actual_price, total_price,  total_pricea,  total_priceb, simage, total_quantity,total_quantitya, total_quantityb, actual_quant,
           orderid,uuid, scity, suid, product_cat, slat, slong,sname, order, quantity, order_id, date, time,product_subcat, pcatname, pcatimage,suba, subb, subc, subd, sube, product_state,state;

    public GetSet() {
    }

    public GetSet(String product_name, String product_quant, String product_image, String actual_price, String total_price,
                  String total_quantity, String actual_quant, String scity, String suid, String product_cat, String slat,
                  String simage, String slong, String sname, String quantity, String order_id, String date, String  time,
                  String pcatname, String pcatimage, String product_subcat, String total_quantitya,String orderid,
                  String total_quantityb, String  total_pricea, String  total_priceb, String bagprice, String product_state,
                  String uuid,String state, String order) {
        ...
        this.state=state;
        this.order= order;
        this.total_pricea = total_pricea;
        this.total_priceb = total_priceb;
        ...
        this.subd = subd;
        this.sube = sube;
        this.product_cat = product_subcat;
    }

    public GetSet(String state) {
        this.state = state;
    }
    ...
    public void setTotal_pricea(String total_pricea) {
        this.total_pricea = total_pricea;
    }
    ...
    public void setTotal_priceb(String total_priceb) {
        this.total_priceb = total_priceb;
    }
    ...
    public void setSubb(String date) {
        this.subb = subb;
    }
