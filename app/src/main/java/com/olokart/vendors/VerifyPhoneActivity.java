                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            sellerMap.put("semail", "!");
                            sellerMap.put("sphone",String.valueOf(phoneNumber));
                            sellerMap.put("sname", String.valueOf(username));
                            sellerMap.put("suid", FirebaseAuth.getInstance().getCurrentUser().getUid());
                            sellerMap.put("scity", "!");
                            sellerMap.put("sstate", "!");
                            sellerMap.put("saddress", "!");
                            sellerMap.put("permission", "unauthorized");
                            sellerMap.put("sctry", "!");
                            sellerMap.put("sstatus", "open");
                            sellerMap.put("szip", "!");
                            sellerMap.put("slat", "0");
                            sellerMap.put("slong", "0");
                            sellerMap.put("simage","!");
                            sellerMap.put("minorder","0");
                            sellerMap.put("delivery","");

                            progressBar.setVisibility(View.GONE);
                            rootRef.child(uid).updateChildren(sellerMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
