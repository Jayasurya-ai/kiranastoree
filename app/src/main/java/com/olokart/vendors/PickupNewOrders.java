...
public class PickupNewOrders extends AppCompatActivity {
    private RecyclerView recyclerView;
    private DatabaseReference reference;
    ArrayList<GetSet> getSets;
    PickupNewOrderAdapter adapter;
    String state="new";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pickup_new_orders);


        recyclerView = findViewById(R.id.PickupOrderRecycler);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    ...
                    adapter = new PickupNewOrderAdapter(PickupNewOrders.this, getSets);
                    recyclerView.setAdapter(adapter);
                }
                // getSets.clear();
