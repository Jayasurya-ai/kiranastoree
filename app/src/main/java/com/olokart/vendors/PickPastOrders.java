...
public class PickPastOrders extends AppCompatActivity {
    private RecyclerView recyclerView;

    private DatabaseReference reference;
    ArrayList<GetSet> getSets;
    PastpickOrderAdapter adapter;
    String state="past";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pick_past_orders);


        recyclerView = findViewById(R.id.pastpickOrderRecycler);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    ...
                    adapter = new PastpickOrderAdapter(PickPastOrders.this, getSets);
                    recyclerView.setAdapter(adapter);
                }
                // getSets.clear();
