    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String minprder = dataSnapshot.child("minorder").getValue().toString();
                String delInfo = dataSnapshot.child("delivery").getValue().toString();
                sname.setText(snamestr);
                scity.setText(scitystr);
                if (minprder.equals("0") || delInfo.equals("")) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_orders:
                        Intent intent=new Intent(SellerAddActivity.this, MyProfileActivity.class);
